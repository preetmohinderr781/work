...
#Decode json Response To Array
 $ZohoDataHook=explode("=",$json1);
  ...
  file_put_contents("order_inWebhook.txt", $ZohoCrmId . $LogDate. PHP_EOL, FILE_APPEND);
...
//print_r($ZohoData);
 ...
 $ZohoContactNameID= $ZohoData['data'][0]['Contact_Name']['name'];
...
print_r($jsonFright);
         ...
         echo   $response = curl_exec($curl);
            ...
            $LogDate = date("jS  F Y h:i:s A");
            file_put_contents("order_Genreated.txt", $response . $LogDate. PHP_EOL, FILE_APPEND);
