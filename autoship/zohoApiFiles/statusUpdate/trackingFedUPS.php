...
$now = new DateTime();
$begin = new DateTime('10:00:00');
$end = new DateTime('10:59:00');
$begin1 = new DateTime('14:00:00');
$end1 = new DateTime('18:00:00');
$begin2 = new DateTime('21:00:00');
$end2 = new DateTime('21:59:00');
...
//$sql = "SELECT * FROM `zohoWarehouse` WHERE `dupStatus` = '1' AND `status` != 'Delivered'  LIMIT 1";
$sql = "SELECT * FROM `zohoWarehouse` WHERE `dupStatus` = '1' AND `status` != 'Delivered'";
...
if($OrderStatus != $dbTrackStatus)
{
    ...
    file_put_contents('Picked_tracking_log.txt', $LogDate .'--'. $OrderStatus.'----------------' .$dbTrackStatus.'--'. $zoho_id .'--------'.$response. PHP_EOL, FILE_APPEND);
}
