...
//file_put_contents("test_latest.txt", $json);

//file_put_contents("order_test_getJson.txt", $json. PHP_EOL, FILE_APPEND);

#Get Data from the file
 $json1 = file_get_contents('test_latest.txt');
                ...
                if ($WarehouseCode == "USNYCA")
                        {
                            ...
                            elseif (($weightInKGG > "20") && ($weightInKGG <= "21"))
                            {
                                $logProdCode = "F123";
                            }
                            elseif ($weightInKGG > "21")
                            {
                                $logProdCode = "F132";
                            }
                        }
