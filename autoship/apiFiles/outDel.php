...
$sql = "SELECT * FROM `warehouse` WHERE `dupStatus` = '1' AND `status` NOT IN ( 'delivery', 'picked')  LIMIT 1";
...
file_put_contents('OutForDelivery.txt', $LogDate . $WooStatus.'----------------' .$dbTrackStatus. $wooId . PHP_EOL, FILE_APPEND);
