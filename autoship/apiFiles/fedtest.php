...
if ($res = mysqli_query($conn, $sql)) {
         ...
         if($dbStatus != 'delivered' && $dbStatus != "completed" )
         {
            ...
            if($dbStatus != $StatusInWords && $StatusInWords != "" )
            
                {
                    ...
                    file_put_contents('fedTest.txt', $LogDate .'--'. $wooId .'--'. $StatusInWords .'--'.$timestamp. PHP_EOL, FILE_APPEND);
    ...
    file_put_contents('fedFinalLogTEsting.txt', $LogDate .'--'. $wooId .'--'. $StatusInWords .'--'.$dbStatus.'--'.$timestamp. PHP_EOL, FILE_APPEND);
    $StatusInWords='';
$Status='';
$dbTracking='';
