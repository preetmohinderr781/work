...
$sql = "SELECT * FROM `warehouse` WHERE `dupStatus` = '1' AND `status` != 'delivered'  LIMIT 1";
...
file_put_contents('Picked_tracking_log.txt', $LogDate .'--'. $WooStatus.'----------------' .$dbTrackStatus.'--'. $wooId . PHP_EOL, FILE_APPEND);
