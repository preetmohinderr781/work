...
echo'<pre>';
   ...
   $TruncateCompanies="TRUNCATE TABLE `company_users`";
                        $comp_res=$wpdb->get_results($TruncateCompanies);
...
$args5 = array(
    'role'    => 'small_business_admin',
);
$users5 = get_users( $args5 );

$data = array_merge($users4,$users5);
